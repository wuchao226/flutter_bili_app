...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    ...
    request.addParams("qwew", 222).addParams("ee", 44).addParams("requestPrams", "v");
    ...
    SharePrefsCache.getInstance().setString("aaa", "value");
    var val = SharePrefsCache.getInstance().get("aaa");
    LoggerUtil.d(val);
  }
